...
public class Fenetre extends JFrame {
    ...
    JButton square = new JButton(new ImageIcon("images/carre .png")),
            circle = new JButton(new ImageIcon("images/cercle.png")),
            red = new JButton(new ImageIcon("images/carre-rouge.png")),
            green = new JButton(new ImageIcon("images/carre -vert.png")),
            blue = new JButton(new ImageIcon("images/carre-bleu.png"));
